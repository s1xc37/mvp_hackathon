...
COOL_RATE_TIPPER = 0.0004      # обычный самосвал без укрытия
COOL_RATE_TARP   = 0.0002      # под тентом
COOL_RATE_HEATED = 0.00005     # термокузов с подогревом (база при +10°C и выше)
COOLING_SLOWDOWN = 0.1
...
MIX_USABLE_MIN_C  = 120    # минимум для начала уплотнения
MIX_OPTIMAL_MIN_C = 125     # запас на предварительное уплотнение 9т катком (145→120°C)
